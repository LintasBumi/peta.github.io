...
app.controller('MainCtrl', function($scope, $http) {
  ...
  var mapOptions = {
    zoom: 4,
    scrollwheel: false,
    center: new google.maps.LatLng(-3.25, 118),
  ...
  stateLayer.loadGeoJson('https://raw.githubusercontent.com/LintasBumi/peta.github.io/master/indoprov.geojson');
  ...
  stateLayer.addListener('click', function(e) {
    ...
    infoWindow.setContent('<div style="line-height:1.00;overflow:hidden;white-space:nowrap;">' +
      e.feature.getProperty('PROVINSI') + '<br> UNDUH: ' + '<a target="_blank" href="' +
      e.feature.getProperty('UNDUH') + '">UNDUH</a>' + '</div>');
